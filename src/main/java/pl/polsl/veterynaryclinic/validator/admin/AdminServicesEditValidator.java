...
@Component
public class AdminServicesEditValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        validateSameType(service.getServiceId(), service.getServiceType(), errors);
    }
    ...
    private void validateSameType(Integer id, String type, Errors errors) {
        ...
        for (Service s : services) {
        	if (type.toUpperCase().equals(s.getServiceType().toUpperCase()))
        		if (!(s.getServiceId().equals(id)))
        			errors.rejectValue("serviceType", "err_code", "Taka usługa już istnieje w bazie");
        }
