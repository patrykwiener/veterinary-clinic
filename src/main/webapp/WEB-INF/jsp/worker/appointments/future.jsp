...
<head>
    ...
    <script type="text/javascript">
        ...
        function get_patients() {
            return $.ajax({
                type: "GET",
                url: "/worker/appointments/future/get_patients",
        ...
        function get_clients() {
            ...
            return $.ajax({
                type: "GET",
                url: "/worker/appointments/future/get_clients",
                success: function (data) {
        ...
        function select_client() {
            $.ajax({
                type: "GET",
                url: "/worker/appointments/future/select_client",
                data: {
        ...
        function select_patient() {
            $.ajax({
                type: "GET",
                url: "/worker/appointments/future/select_patient",
                data: {
        ...
        function get_appointments() {
            return $.ajax({
                type: "GET",
                url: "/worker/appointments/future/get_appointments",
                success: function (data) {
